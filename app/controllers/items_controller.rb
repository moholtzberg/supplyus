class ItemsController < ApplicationController
  ...
  def registration_params
    params.require(:item).permit(:number, :description, :price, :cost_price, :sale_price, :model_id, :is_serialized, :weight, :height, :width, :length, :item_type_id, :category_id)
  end
